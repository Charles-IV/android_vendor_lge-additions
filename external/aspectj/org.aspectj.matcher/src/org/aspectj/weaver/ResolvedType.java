	...
	public ResolvedType getDeclaringType() {
		...
		if (isNested() || isAnonymous()) {
            try {
                ...
                /*
                 * Aspectj Compiler haven't handled(actually, they said "give up") some nested classes,
                 * that the classes didn't have an outer class information
                 * while those classes didn't follow java naming convention(including $ to represent inner class) caused by proguard.
                 * We have got this situation as described in LGSF-4632 so ignore any exceptions or throws from it to keep going the rest of compilation.
                 */
                System.out.println("We ignore any errors or exceptions from getOuterClass(): " + e);
                return null;
            }
		}
		return null;
