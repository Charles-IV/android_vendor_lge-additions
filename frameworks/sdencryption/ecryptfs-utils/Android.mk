...
LOCAL_REQUIRED_MODULES := libecryptfs_key_mod_passphrase
...
ifeq ($(TARGET_PRODUCT), $(filter $(TARGET_PRODUCT), cf_lgu_kr cf_skt_kr cf_kt_kr cf_global_com t1lte_att_us t1lte_usc_us t1lte_global_com t1wifi_global_com t1wifin_global_com))
    LOCAL_CFLAGS += -DLGE_DIFFER_HEX
endif
