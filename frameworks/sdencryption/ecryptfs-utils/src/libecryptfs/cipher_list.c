...
#ifdef __LP64__
       strncpy(dir_name, "/lib64/modules/", MAX_NAME_SIZE);
#else
...
#ifdef __LP64__
       rc = asprintf(&kernel_crypto_dir, "/lib64/modules/%s/kernel/crypto",
                     kern_info.release);
#else
